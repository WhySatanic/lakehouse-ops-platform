...
> Status: version `1.14.3`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.14.3 release notes](docs/releases/1.14.3.md) describe portable, confined schema
resolution for every public control-plane output.
