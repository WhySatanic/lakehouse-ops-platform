...
> Status: version `1.9.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.9.0 release notes](docs/releases/1.9.0.md) describe runtime schema validation
for Iceberg maintenance plans.
