...
> Status: version `1.11.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.11.0 release notes](docs/releases/1.11.0.md) describe runtime schema validation
for Trino compaction experiment comparisons.
