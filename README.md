...
> Status: version `1.14.5`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.14.5 release notes](docs/releases/1.14.5.md) describe explicit schema dialect and
unique identity checks for every public control-plane output.
