...
> Status: early access `0.35.0`. Open-Meteo ingestion works against the local filesystem
...
The optional observability profile exposes Prometheus readiness signals for MinIO,
Hive Metastore, and Trino. See [the readiness runbook](docs/runbooks/prometheus-readiness.md).
