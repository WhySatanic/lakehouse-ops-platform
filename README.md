...
> Status: version `1.15.1`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.15.1 release notes](docs/releases/1.15.1.md) describe pre-commit validation for
atomic public schema digest refreshes.
