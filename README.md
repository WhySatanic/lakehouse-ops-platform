...
> Status: version `1.15.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.15.0 release notes](docs/releases/1.15.0.md) describe the atomic workflow for
refreshing reviewed public schema digests in the stable control-plane contract.
