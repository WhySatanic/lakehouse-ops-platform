...
> Status: version `1.14.8`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.14.8 release notes](docs/releases/1.14.8.md) describe rejection of ambiguous
duplicate anchors in self-contained public output schemas.
