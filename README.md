...
> Status: version `1.7.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.7.0 release notes](docs/releases/1.7.0.md) describe runtime schema validation
for the release-candidate bundle report.
