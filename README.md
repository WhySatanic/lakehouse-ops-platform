...
> Status: version `1.2.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.2.0 release notes](docs/releases/1.2.0.md) describe the versioned S3 landing
readiness invariant and its upgrade path.
