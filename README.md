...
> Status: version `1.14.9`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.14.9 release notes](docs/releases/1.14.9.md) describe canonical uniqueness checks
for nested public schema resource identifiers.
