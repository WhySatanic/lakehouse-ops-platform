...
> Status: version `1.14.10`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.14.10 release notes](docs/releases/1.14.10.md) describe digest binding for every
public output schema in the stable control-plane contract.
