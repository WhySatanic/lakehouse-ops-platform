...
> Status: version `1.3.1`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.3.1 release notes](docs/releases/1.3.1.md) describe executable CLI option
semantics and the compatibility upgrade path.
