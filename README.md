...
> Status: version `1.16.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.16.0 release notes](docs/releases/1.16.0.md) describe offline verification of
