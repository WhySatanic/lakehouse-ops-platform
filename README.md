...
> Status: version `1.14.2`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.14.2 release notes](docs/releases/1.14.2.md) describe metaschema validation for
every public control-plane output schema.
