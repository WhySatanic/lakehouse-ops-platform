...
> Status: version `1.14.4`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.14.4 release notes](docs/releases/1.14.4.md) describe fail-closed binding between
each public output version and its JSON Schema.
