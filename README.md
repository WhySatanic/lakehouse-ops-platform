...
> Status: version `1.12.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.12.0 release notes](docs/releases/1.12.0.md) describe runtime schema validation
for Trino partition-pruning experiment reports.
