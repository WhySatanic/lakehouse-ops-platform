...
> Status: version `1.3.0`, stable `1.0.0` control-plane contract, and reproducible
> reference stack.
...
The [1.3.0 release notes](docs/releases/1.3.0.md) describe the S3 landing history audit
