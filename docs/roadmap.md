...
- [ ] Incrementally merge validated commerce data into Spark/Iceberg bronze and silver
  ...
  - [x] Deduplicate and validate selected commerce orders into Iceberg silver, retain
...
- [x] Model customer history with SCD2 and publish a tested daily gold mart for revenue,
